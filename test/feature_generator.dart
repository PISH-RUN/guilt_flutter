  ...
  Feature feature = const Feature(
    ...
    taskList: [
      Task(
        id: 1,
        cubitName: "AllGuilds",
        methodName: "getAllGuildsByCities",
        method: Method.getList,
        source: Source.restful,
        facadeFunctionOutput: "Guild",
        facadeFunctionParams: [Param(id: 1, type: "List<String>", name: "cities"), Param(id: 2, type: "int", name: "page")],
        cubitEntityForSuccess: Param(id: 1, type: "List<Guild>", name: "guildList"),
        offlineMethod: OfflineMethod.justOnline,
      ),
      Task(
        id: 2,
        cubitName: "updateStateOfGuild",
        methodName: "updateStateOfSpecialGuild",
        method: Method.post,
        source: Source.restful,
        facadeFunctionOutput: "Guild",
        facadeFunctionParams: [Param(id: 1, type: "Guild", name: "guild")],
    ...
    entityList: [
      Entity(
        ...
        properties: [
          Property(id: 1, type: "Guild", name: "guild", isEquatable: true),
          Property(id: 2, type: "GuildState", name: "guildState"),
        ],
      ),
    ],
  );
