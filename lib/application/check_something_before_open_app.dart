...
Future<Either<ServerFailure, List<FaqQuestion>>> getListOfFaqQuestions() async {
  return const Right(
    [
      FaqQuestion(question: 'با یک کد ملی حق ثبت چند کسب و کار وجود دارد ؟', answer: 'بله، با یک کد ملی خاص کاربر می تواند تا هر تعداد صنف را در سایت ثبت کرده و محدودیتی در این زمینه وجود ندارد .'),
