...
Future<Either<ServerFailure, List<FaqQuestion>>> getListOfFaqQuestions() async {
  return const Right(
    [
      FaqQuestion(question: 'با یک کد ملی حق ثبت چند صنف وجود دارد ؟', answer: 'بله، با یک کد ملی خاص کاربر می تواند تا هر تعداد صنف را در سایت ثبت کرده و محدودیتی در این زمینه وجود ندارد .'),
      FaqQuestion(question: 'در صورت مغایرت اطلاعات چه باید کرد؟', answer: 'شما باید در صورت مغایرت اطلاعات خود و یا صنف مورد نظرتان آن را ویرایش نموده و منتظر تایید نهایی آن باشید.'),
